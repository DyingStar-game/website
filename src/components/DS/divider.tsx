...
export const Divider = ({ className, children, ...props }: DividerProps) => {
  return (
    <span className={cn("relative flex justify-center", className)} {...props}>
      <div className="via-gray-500 absolute inset-x-0 top-1/2 h-px -translate-y-1/2 bg-transparent bg-gradient-to-r from-transparent to-transparent opacity-75"></div>
