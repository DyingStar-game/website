...
import {
  handleDialogAction,
  useDialogStore,
} from "@feat/dialog-manager/dialogStore";
import type { Dialog } from "@feat/dialog-manager/dialogTypes";
import { LoadingButton } from "@feat/form/submitButton";
import { cn } from "@lib/utils";

/* eslint-disable @typescript-eslint/prefer-nullish-coalescing */

export const DialogComponent = (props: { dialog: Dialog }) => {
  const { dialog } = props;
